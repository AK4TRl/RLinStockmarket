...
def train_A2C(env_train, model_name, timesteps=25000):
    ...
    start = time.time()
    model = A2C('MlpPolicy', env_train, verbose=0, tensorboard_log="./data/log2/")
...
def train_DDPG(env_train, model_name, timesteps=10000):
    ...
    model = DDPG('MlpPolicy', env_train, action_noise=action_noise, tensorboard_log="./data/log2/")
    model.learn(total_timesteps=timesteps)
    end = time.time()
...
def train_PPO(env_train, model_name, timesteps=50000):
    ...
    model = PPO('MlpPolicy', env_train, ent_coef=0.005, batch_size=8, tensorboard_log="./data/log2/")
...
def run_ensemble_strategy(df, unique_trade_date, rebalance_window, validation_window) -> None:
    ...
    insample_turbulence = df[(df.datadate<20151000) & (df.datadate>=20101200)]
    ...
    for i in range(rebalance_window + validation_window, len(unique_trade_date), rebalance_window):
        ...
        print("======Model training from: ", 20101200, "to ",
